            ...
            <Box>
              <TabList
                ...
                <Tab
                  label="Tầm nhìn"
                  value="1"
                  className={cx('myCustomTab', {
                    myCustomTabActive: value === '1',
                  })}
                />
                <Tab
                  label="Sứ mệnh"
            ...
            <TabPanel value="1">
              <div className={cx('tab')}>
                ...
                <div className={cx('content')}>
                  ...
                  mong muốn trở thành công ty có phần mềm luyện thi được sinh
                  viên sử dụng phổ biến nhất trong nước.
                </div>
              </div>
            </TabPanel>
            <TabPanel value="2">
              <div className={cx('tab')}>
                ...
                <div className={cx('content')}>
                  Sứ mệnh của OTSV là phát triển phần mềm luyện thi thay đổi
                  cách học và ôn thi thông qua công cụ với nội dung bám sát
                  chương trình học và tính năng thông minh tăng hiệu quả học
                  tập.
                </div>
              </div>
            </TabPanel>
              ...
              <div className={cx('tab1')}>
                <div className={cx('item')}>
                  ...
                  <div className={cx('item-content')}>
                    ...
                    <div className={cx('content')}>
                      Đội ngũ Ôn thi sinh viên từ những anh/chị biên soạn nội
                      dung, đến anh/chị admin tin tức và admin học tập luôn
                      <span> NHIỆT TÌNH, TÂM HUYẾT </span>
                      phục vụ vì sinh viên, là người bạn đồng hành trong học
                      tập.
                    </div>
                  </div>
                </div>
                <div className={cx('item')}>
                  ...
                  <div className={cx('item-content')}>
                    ...
                    <div className={cx('content')}>
                      Các khóa luyện luôn bám sát chương trình học và đề thi
                      theo từng trường đại học. Sinh viên có thể làm quen với
                      các dạng bài tập, câu hỏi lý thuyết để tăng tốc độ làm đề.
                      Bằng ứng dụng
                      <span> CNTT </span>
                      sẽ giúp sinh viên học tập mọi lúc mọi nơi, trên nhiều
                      thiết bị. Tự động xác định những phần kiến thức yếu của
                      học viên để cải thiện..
                    </div>
                  </div>
                </div>
                <div className={cx('item')}>
                  ...
                  <div className={cx('item-content')}>
                    ...
                    <div className={cx('content')}>
                      ...
                      mà còn năng động và sáng tạo. Không ngừng học hỏi và vượt
                      qua mọi giới hạn. Sẵn sàng tiếp nhận tích cực những đóng
                      góp từ phía học viên và cải thiện nội dung hàng kỳ. Giữ
                      trong mình những chuẩn mực đạo đức, văn hóa và tác phong
            ...
            <TabPanel value="5">
              <div className={cx('tab5')}>
                ...
                <div className={cx('item')}>
                  <img
                    className={cx('tab5')}
                    src="https://onthisinhvien.com/images/icon/otsv/chat-luong.svg"></img>
                  <div className={cx('text-content-tab5')}>
                    ...
                    động, bình đẳng và hồn nhiên. Các hoạt động nổi bật:
